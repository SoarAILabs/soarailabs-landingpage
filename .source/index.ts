...
export const blogPosts = _runtime.doc<typeof _source.blogPosts>([{ info: {"path":"introducing-glide.mdx","fullPath":"content\\blog\\introducing-glide.mdx"}, data: d_blogPosts_0 }]);
